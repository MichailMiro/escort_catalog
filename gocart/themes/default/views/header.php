...
<?php echo theme_js('jquery.dataTables.js', true);?>

<?php echo theme_js('jquery.fancybox.js', true);?>
<?php echo theme_js('jquery.fancybox.pack.js', true);?>
					...
					<ul class="nav">
						...
						<li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">City <b class="caret"></b></a>
							<ul class="dropdown-menu">
								...
								<li><a href="<?php echo SITE_URL;?>cart/city/<?php echo $city->escort_city;?>"><?php echo $city->escort_city;?></a></li>
								<?php endforeach;?>
							</ul>
						</li>	
						<?php
						...
						?>
                                                ...
                                                <li>
                                                    <a href="<?php echo SITE_URL;?>cart/submit_your_content">Submit Your Content</a>
                                                </li>    
                                                <?php
                                                if(false)
